class Mushroom {
    constructor(x, y, scale, hue, index) {
        this.x = x;
        this.y = y;
        this.scaleFactorX = scale;
        this.initialScale = scale;
        this.hue = hue;
        this.compliment = this.hue + 180;
        this.initialHue = hue;
        this.index = index;
        this.grow = false;
        this.shrink = false;
    ...
    display() {
      ...
      update(){
        ...
        if (currentNote == this.index){
            this.hue = this.compliment;
            this.scaleFactorX *= 1.005
        } else {
            this.hue =  this.initialHue;
            this.scaleFactorX = this.initialScale;
        }
